...
class MyProxyUtils(object):
	...
	def get_trustroots(self):
		# Get trust roots
		self.trustRoots = self.myproxy.getTrustRoots(self.config['accounts']['root_account'],
							     self.config['accounts']['root_password'],
	...
	def get_credentials(self):
		# Get credentials (and trustroots)
                self.credentials = self.myproxy.logon(self.config['accounts']['root_account'],
                                                      self.config['accounts']['root_password'])
		# Write Credentials
